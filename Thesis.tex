...
\documentclass[10pt,twoside,a5paper,fleqn]{scrbook}
...
% First page of the thesis **has to be** the official page of the program
\newlength{\originalVOffset}
 ...
 %% If you are in the joint PhD program, then doppeldoktort page has to be used
